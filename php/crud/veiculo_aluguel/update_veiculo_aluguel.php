...
$sql = "update veiculo_aluguel set motorista_id=$motorista_id,veiculo_id=$veiculo_id,data_hora_inicio='$data_hora_inicio',km_inicial=$km_inicial , data_hora_fim='$data_hora_fim' , km_final=$km_final where id=$id";
